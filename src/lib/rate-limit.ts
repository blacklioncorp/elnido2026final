...
export const boletosLimiter = new RateLimiter(60 * 1000, 5) // 5 por minuto
export const descuentoLimiter = new RateLimiter(60 * 1000, 10) // 10 por minuto
...
if (typeof setInterval !== 'undefined') {
  setInterval(() => {
    ...
    boletosLimiter.cleanup()
    descuentoLimiter.cleanup()
