...
import Visitanos from '@/components/ubicacion/Visitanos'
    ...
    <div className="container mx-auto px-4 py-16 max-w-5xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
        ...
        <form onSubmit={handleSubmit} className="lg:col-span-3 bg-forest-green-light/40 backdrop-blur-sm rounded-3xl border border-white/10 p-8 space-y-5">
          ...
          <button type="submit" disabled={loading || !turnstileToken} className="w-full bg-conservation-gold hover:bg-conservation-gold/90 disabled:opacity-60 text-forest-green-dark font-extrabold py-4 rounded-xl transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2">
            {loading
      ...
      {/* Sección Visítanos con Mapa y Botones de Transporte */}
      <Visitanos className="mt-16" />
    </div>
  )
}
