...
export default async function HomePage() {
  ...
  const heroImages: string[] = [
    "/hero/1_Quetzal_Chucho.svg",
    "/hero/2_hero.svg",
    "/hero/3_Jaguar_Samba.svg",
    "/hero/4_hero_grupoos.svg",
    "/hero/5_Guacamaya_Jacinta.svg"
  ];
  ...
  return (
    <>
      ...
      <section className="py-24 bg-off-white text-forest-green-dark">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <div className="w-[180px] h-[180px] mx-auto rounded-full shadow-xl border-4 border-conservation-gold mb-8 relative overflow-hidden">
            <Image
              src="/fundador/dr-espaldas_de_perfil.JPG"
      ...
      <VideoTestimonial
        videoUrl="/video/video2_comprimido.webm"
