      ...
      <div className="container mx-auto px-4 py-10 max-w-5xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-10">
          {[
            ...
            { label: 'Meses como guardián', value: mockSponsorships.length > 0 ? '1' : '0', icon: Calendar, color: 'text-emerald-400' },
          ...
          <div>
            ...
            <div className="space-y-4">
              {mockSponsorships.length === 0 ? (
                <div className="bg-forest-green-light/40 rounded-2xl border border-white/10 p-5 text-center text-off-white/60 text-sm">
                  Aún no tienes apadrinamientos activos.
                </div>
              ) : (
          ...
          <div>
            ...
            <div className="bg-forest-green-light/40 rounded-2xl border border-white/10 divide-y divide-white/5">
              {mockDonations.length === 0 ? (
                <div className="p-5 text-center text-off-white/60 text-sm">
