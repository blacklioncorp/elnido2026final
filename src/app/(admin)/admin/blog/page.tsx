export default function AdminSubPage() {
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-off-white tracking-tight">Entradas del Blog</h1>
        <p className="text-off-white/50 mt-1">Crea y edita contenido del blog</p>
      </div>
