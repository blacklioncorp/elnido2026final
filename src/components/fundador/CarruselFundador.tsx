...
const FOTOS = [
  {
    url: 'https://gbvlbavpyzbcmnxpdaxg.supabase.co/storage/v1/object/public/fundador/dr_ovalo.jpg',
    caption: 'Los años de formación: UNAM y Ohio State University',
  },
  {
    url: 'https://gbvlbavpyzbcmnxpdaxg.supabase.co/storage/v1/object/public/fundador/dr_en_pradera_boliviana.JPG',
    caption: '1975: Expedición en Bolivia donde descubrió Crax estudilloi',
  },
  {
    url: 'https://gbvlbavpyzbcmnxpdaxg.supabase.co/storage/v1/object/public/fundador/dr_con_hijo.JPG',
    caption: 'Familia y conservación: un legado compartido',
  },
  {
    url: 'https://gbvlbavpyzbcmnxpdaxg.supabase.co/storage/v1/object/public/fundador/dr_microscopio.JPG',
    caption: 'Ciencia al servicio de la vida silvestre',
  },
  {
    url: 'https://gbvlbavpyzbcmnxpdaxg.supabase.co/storage/v1/object/public/fundador/dr_con_nuevas_generaciones.JPG',
    caption: 'Educando a las nuevas generaciones',
  },
  {
    url: 'https://gbvlbavpyzbcmnxpdaxg.supabase.co/storage/v1/object/public/fundador/dr_con_avestruspolluelo.JPG',
    caption: 'El cuidado de cada individuo como esencia',
  },
  {
    url: 'https://gbvlbavpyzbcmnxpdaxg.supabase.co/storage/v1/object/public/fundador/dr_observando_legado.JPG',
    caption: 'Contemplando la vida que ayudó a proteger',
  },
  {
    url: 'https://gbvlbavpyzbcmnxpdaxg.supabase.co/storage/v1/object/public/fundador/dr-espaldas_de_perfil.JPG',
